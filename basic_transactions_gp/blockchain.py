...
class Blockchain(object):
    ...
    def hash(self, block):
        ...
        hashed_block_string = hashlib.sha256(block_string.encode())
        ...
        return hashed_block_string.hexdigest()
...
def mine():
    ...
    new_block = blockchain.new_block(proof, previous_hash=block_hash)
    
    # Award the miner with some coin
...
def new_transaction():
    ...
    response = {
        'message': f'New transaction added to block {len(blockchain.chain)}!'
    }
